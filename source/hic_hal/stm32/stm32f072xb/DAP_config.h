...
{
    LL_GPIO_SetPinOutputType(GPIOx, (1 << pin_bit), LL_GPIO_OUTPUT_PUSHPULL);
    LL_GPIO_SetPinMode(GPIOx, (1 << pin_bit), LL_GPIO_MODE_OUTPUT);
}

__STATIC_INLINE void pin_out_od_init(GPIO_TypeDef* GPIOx, uint8_t pin_bit)
{
    LL_GPIO_SetPinOutputType(GPIOx, (1 << pin_bit), LL_GPIO_OUTPUT_OPENDRAIN);
    LL_GPIO_SetPinMode(GPIOx, (1 << pin_bit), LL_GPIO_MODE_OUTPUT);
}
...
__STATIC_INLINE void pin_in_init(GPIO_TypeDef* GPIOx, uint8_t pin_bit, uint8_t mode)
{
    ...
    LL_GPIO_SetPinPull(GPIOx, (1 << pin_bit), pull);
    LL_GPIO_SetPinMode(GPIOx, (1 << pin_bit), LL_GPIO_MODE_INPUT);
}
//**************************************************************************************************
/**
